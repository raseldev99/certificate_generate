    ...
    <form class="max-w-md" wire:submit="generate">
       ...
       <div class="flex gap-x-4">
           <button wire:loading.attr="disabled" type="submit" class="bg-green-600 text-white py-2 px-5 rounded">
               Generate
               <svg wire:loading wire:target="generate,file" aria-hidden="true" role="status" class="inline w-4 h-4 me-3 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
